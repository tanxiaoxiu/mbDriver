setwd("~/mDriver/simulation/toy_example")
library(tidyverse)
library(readxl)
library(ggpubr)
library(pheatmap)
...
rownames(r0) <- c("A","B","C")
colname2 <- "r"
A0 <- matrix(data=1, nrow = p, ncol = p, byrow = FALSE, dimnames = NULL)
A0[2:p,] <- 0
...
compare_D_fork$Group <- c(rep("D1", 3), rep("D2", 3), rep("D3", 3))
...
compare_D_collider$Group <- c(rep("D1", 3), rep("D2", 3), rep("D3", 3))
...
rownames(r0) <- c("A","B","C")
colname2 <- "r"
A0 <- matrix(data=0, nrow = p, ncol = p, byrow = FALSE, dimnames = NULL)
A0[1,2] <- 1
A0[2,3] <- 1
diag(A0) <- rep(-1,times=p)
rownames(A0) <- c("A","B","C")
...
compare_D_chain$Group <- c(rep("D1", 3), rep("D2", 3), rep("D3", 3))
...
rownames(r0) <- c("A","B","C")
colname2 <- "r"
A0 <- t(matrix(data = c(1,2,3), nrow = p, ncol = p, byrow = FALSE, dimnames = NULL))
A0[2:p,] <- 0
diag(A0) <- rep(-1,times=p)
rownames(A0) <- c("A","B","C")
#Index:D1,D2,D3
...
rownames(r0) <- c("A","B","C")
colname2 <- "r"
A0 <- matrix(data = c(1,2,3), nrow = p, ncol = p, byrow = FALSE, dimnames = NULL)
A0[,2:p] <- 0
diag(A0) <- rep(-1,times=p)
rownames(A0) <- c("A","B","C")
#Index:D1,D2,D3
