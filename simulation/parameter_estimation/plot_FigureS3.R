...
setwd("~/mbDriver/simulation/parameter_estimation/supplementary/n15")
main_result_baseDir = "~/mbDriver/simulation/parameter_estimation/supplementary/n15"
...
plot3 <- g + geom_col(aes(fill = Group,y= RMSE_A), position = position_dodge())+
  ...
  theme(panel.grid.major=element_line(colour=NA),
        ...
        plot.background = element_rect(fill = "transparent",colour = NA),
        panel.grid.minor = element_blank())
plot_FigureS3A <- plot_grid(plot1,plot2,plot3, ncol=3, nrow=1)
ggsave(filename="plot_FigureS3A.png",plot=plot_FigureS3A,device="png",dpi=600,units="in",width=18,height=6)
...
plot6 <- g + geom_col(aes(fill = Group,y= RMSE_A), position = position_dodge())+
  ...
  theme(panel.grid.major=element_line(colour=NA),
        ...
        plot.background = element_rect(fill = "transparent",colour = NA),
        panel.grid.minor = element_blank())
plot_FigureS3B <- plot_grid(plot4,plot5,plot6, ncol=3, nrow=1)
ggsave(filename="plot_FigureS3B.png",plot=plot_FigureS3B,device="png",dpi=600,units="in",width=18,height=6)
