...
for (iter in 1:iterations){
  ...
  end_lse_time <- Sys.time() 
  lse_time <- end_lse_time - start_lse_time 
  ...
  end_lasso_time <- Sys.time() 
  lasso_time <- end_lasso_time - start_lasso_time 
  ...
  end_elastic_time <- Sys.time() 
  elastic_time <- end_elastic_time - start_elastic_time
