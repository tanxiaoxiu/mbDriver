...
regulation_ID = "theta1"#c("theta1", "theta3", "theta5")
...
plot_Figure4A <- plot_grid(plot1,plot2,plot3,plot4, ncol=2, nrow=2)
ggsave(filename="plot_Figure4A.png",plot=plot_Figure4A,device="png",dpi=600,units="in",width=12,height=12)

###Figure4B
setwd("~/mbDriver/simulation/parameter_estimation/dense")
main_result_baseDir = "~/mbDriver/simulation/parameter_estimation/dense/"
main_result_timer= c("t8", "t13", "t18", "t25")
regulation_ID = "theta1"#c("theta1", "theta3", "theta5")
...
plot_Figure4B <- plot_grid(plot1,plot2,plot3,plot4, ncol=2, nrow=2)
ggsave(filename="plot_Figure4B.png",plot=plot_Figure4B,device="png",dpi=600,units="in",width=12,height=12)
