...
ggsave(filename="FigureS8A.png",plot=p1,device="png",dpi=600,units="in",width=6,height=5)
...
p2 <- ggplot(df2,aes(x=Group,y=Simpson))+
  ...
  theme_prism(
    ...
    axis_text_angle = 0)+ 
  theme(legend.position = 'none')
ggsave(filename="FigureS8B.png",plot=p2,device="png",dpi=600,units="in",width=6,height=5)
...
p3
ggsave(filename="FigureS8C.png",plot=p3,device="png",dpi=600,units="in",width=6,height=5)
