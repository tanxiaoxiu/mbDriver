...
p1
ggsave(filename="FigureS7A.png",plot=p1,device="png",dpi=600,units="in",width=6,height=5)
...
p2 <- ggplot(df2,aes(x=Group,y=Simpson))+
  ...
  theme(legend.position = 'none')
p2
ggsave(filename="FigureS7B.png",plot=p2,device="png",dpi=600,units="in",width=6,height=5)
...
p3
ggsave(filename="FigureS7C.png",plot=p3,device="png",dpi=600,units="in",width=6,height=5)
